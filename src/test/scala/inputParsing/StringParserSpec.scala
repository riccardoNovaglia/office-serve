...
class StringParserSpec extends FlatSpec with Matchers with TestDataUtils {
  ...
  "Points" should "extract the correct value from a binary string" in {
    ...
    PointsScored.getValueFrom(specExampleTeam1ScoresBinary) should be(2)
    PointsScored.getValueFrom(specExampleTeam2ScoresBackBinary) should be(3)
  }
  ...
  "ScoringTeam" should "extract the correct value from a binary string" in {
    ...
    ScoringTeam.getValueFrom(specExampleTeam1ScoresBinary) should be(0)
    ScoringTeam.getValueFrom(specExampleTeam2ScoresBackBinary) should be(1)
  }
  ...
  "Team2Total" should "extract the correct value from a binary string" in {
    ...
    Team2Total.getValueFrom(specExampleTeam1ScoresBinary) should be(0)
    Team2Total.getValueFrom(specExampleTeam2ScoresBackBinary) should be(3)
  }
  ...
  "Team1Total" should "extract the correct value from a binary string" in {
    ...
    Team1Total.getValueFrom(specExampleTeam1ScoresBinary) should be(2)
    Team1Total.getValueFrom(specExampleTeam2ScoresBackBinary) should be(2)
  }
  ...
  "elapsedTimeInSeconds" should "extract the correct value from a binary string" in {
    ...
    ElapsedTimeInSeconds.getValueFrom(specExampleTeam1ScoresBinary) should be(15)
    ElapsedTimeInSeconds.getValueFrom(specExampleTeam2ScoresBackBinary) should be(30)
  }
}
